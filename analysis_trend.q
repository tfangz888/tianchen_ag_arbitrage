...
profit:{[file] 
  ...
  ////////////////////////////   calculate profit   //////////////////////
  a:(sym2SellOrders `nask1)*(sym2SellOrders `EnterSellSizeSym2);
  b:(sym2SellOrders `nbid1)*(sym2SellOrders `ExitSellSizeSym2);
  sym2SellProfit: a+b;
  ...
  a:(sym2BuyOrders `nbid1)*(sym2BuyOrders `EnterBuySizeSym2);
  b:(sym2BuyOrders `nask1)*(sym2BuyOrders `ExitBuySizeSym2);
  sym2BuyProfit: a+b;
  ...
  a:(sym1BuyOrders `nbid1)*(sym1BuyOrders `EnterBuySizeSym1);
  b:(sym1BuyOrders `nask1)*(sym1BuyOrders `ExitBuySizeSym1);
  sym1BuyProfit: a+b;
  ...
  a:(sym1SellOrders `nask1)*(sym1SellOrders `EnterSellSizeSym1);
  b:(sym1SellOrders `nbid1)*(sym1SellOrders `ExitSellSizeSym1);
  sym1SellProfit: a+b;
